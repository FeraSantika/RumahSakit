...
class LaporanantrianpasienrawatjalanExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithMapping
{
    public $tglAwal;
    public $tglAkhir;
    public $poli;
    ...
    public function headings(): array
    {
        ...
        $filterText = [
            ...
            [$hospitalAddress],
            [],
            ['Laporan Antrian Pasien Rawat Jalan'],
            [],
        ];
    ...
    {
        return 'Laporan_Antrian_Pasien_Rawat_Jalan';
    }
