...
class LaporankartuantrianapotekerExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithMapping
{
    public $tglAwal;
    public $tglAkhir;
    ...
    {
        $result = CetakDataAntrianObat::whereBetween('tanggal_antrian', [$this->tglAwal, $this->tglAkhir])->get();;
    ...
    {
        return 'Laporan_Kartu_Antrian_Apotek';
    }
