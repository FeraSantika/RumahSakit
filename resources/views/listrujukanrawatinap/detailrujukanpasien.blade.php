            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('list-daftar-pasienInap') }}">List Daftar
                                    Pasien</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('list-daftar-pasienInap') }}">List Rujukan Pasien
                                    Rawat Inap</a>
                            </li>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <h4 class="page-title">Detail Rujukan Pasien Rawat Inap</h4>
                    </div>
                </div>
            </div>
        </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-centered dt-responsive">
                                                            ...
                                                            <tbody id="rujukanList">
                                                                <tr id="row">
                                                                    <td>{{ $item->listrujukan->lab->nama_lab ?? '' }}</td>
                                                                    <td>{{ $item->listrujukan->keterangan ?? '' }}</td>
                ...
                <div class="card-body">
                    <div class="tab-content mb-3">
                        {{-- @foreach ($list as $pendaftar) --}}
                            <form action="{{ route('upload.file-rujukan-pasienInap', $pendaftar->list_id) }}"
