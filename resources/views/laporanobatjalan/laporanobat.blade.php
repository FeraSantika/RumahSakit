                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Pasien Rawat Jalan</a>
                                </li>
                            </ol>
                        </div>
                        <h4 class="page-title">Laporan Obat Pasien Rawat Jalan</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
...
@section('script')
    <script>
        function tampilkanData() {
            ...
            const url =
                `/admin/laporan-obatJalan/get_data?tanggalAwal=${tanggalAwal}&tanggalAkhir=${tanggalAkhir}
        ...
        function exportPDFWithDates() {
            ...
            var pdfURL = "{{ route('laporan-obatJalan.export-pdf') }}" + "?tanggalAwal=" + tanggalAwal +
                "&tanggalAkhir=" +
                tanggalAkhir;
        ...
        function exportExcel() {
            ...
            var excelURL = "{{ route('laporan-obatJalan.export-excel') }}" + "?tanggalAwal=" + tanggalAwal +
