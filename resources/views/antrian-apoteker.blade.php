                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card widget-flat bg-primary">
                                    <div class="card-body text-center">
                                        <form action="{{ route('antrian_obat-update') }}" method="POST">
                                            @csrf
                                            @if ($antrian)
                                                <input type="hidden" name="id_antrian" value="{{ $antrian->id_antrian }}">
                                            @else
                                                <input type="hidden" name="id_antrian" value="0">
                                            @endif
                                            @if ($antrian)
                            ...
                            <div class="col-sm-6">
                                <form action="{{ route('antrian_obat-updatestatus') }}" method="POST">
                                    @csrf
