                    ...
                    <div class="col-xl-12 col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card widget-flat">
                                    <div class="card-body">
                                        <a href="{{ route('laporan-hasilpasienJalan') }}">
                                            <div class="float-end">
                                                <i class="mdi mdi-currency-usd widget-icon"></i>
                                            </div>
                                            <h5 class="text-muted fw-normal mt-0" title="Average Revenue">Pembayaran Pasien
                                                Rawat
                                                Jalan
                                            </h5>
                                            <h3 class="mt-3 mb-3">Rp. {{ number_format($pembayaranjalan, 0, ',', '.') }}
                                            </h3>
                                        </a>
                                    </div> <!-- end card-body-->
                                </div> <!-- end card-->
                            ...
                            <div class="col-sm-6">
                                <div class="card widget-flat">
                                    <div class="card-body">
                                        <a href="{{ route('laporan-hasilpasienInap') }}">
                                            <div class="float-end">
                                                <i class="mdi mdi-currency-usd widget-icon"></i>
                                            </div>
                                            <h5 class="text-muted fw-normal mt-0" title="Growth">Pembayaran Pasien Rawat
                                                Inap
                                            </h5>
                                            <h3 class="mt-3 mb-3"> Rp. {{ number_format($pembayaraninap, 0, ',', '.') }}
                                            </h3>
                                        </a>
                                    </div> <!-- end card-body-->
                                </div> <!-- end card-->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="d-flex card-header justify-content-between align-items-center">
                                <h4 class="header-title">Transaksi Pembayaran</h4>
                            </div>
