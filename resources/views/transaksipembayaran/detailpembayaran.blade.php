        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Detail Transaksi Pembayaran</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
...
@section('script')
    <script type="text/javascript">
        ...
        // Iterate over each "simpan" button and attach an event listener
        ...
        simpanButtons.forEach(button => {
            button.addEventListener('click', function() {
                const pendaftaranId = button.id.split('-')[
                    1]; // Extract the pendaftaran ID from the button ID
                ...
                if (!isNaN(dibayar) && !isNaN(grandtotal)) {
                    ...
                    fetch(`/admin/transaksi-pembayaran/detail/update/${pendaftaranId}`, {
                            method: 'POST',
                            body: formData
                        })
