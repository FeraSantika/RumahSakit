            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Transaksi Pembayaran</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                        ...
                                        @foreach ($dtpendaftar as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <a href="{{ route('transaksi-pembayaran.detail', $item->kode_pendaftaran) }}"
...
@section('script')
    <script type="text/javascript">
        ...
        function printResi(kode) {
            ...
            fetch('/admin/transaksi-pembayaran/detail/update/print/' + kode, {
                    method: 'POST',
                    body: formData
                })
