...
@section('content')
    <div class="container mt-3">
        ...
        <div class="content bg-white border border-light">
            <div class="m-3">
                <form action="{{ route('daftar.pasieninap.store') }}" method="POST" class="mb-3" id="pasien-form"
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function() {
            var path = "{{ route('autocomplete_pasieninap') }}";
            $("#search").autocomplete({
        ...
        var simpan = "{{ route('daftar.pasieninap.store') }}";
