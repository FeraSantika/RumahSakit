                    ...
                    <div class="card-body">
                        ...
                        <div class="text-start mt-3">
                            ...
                            <p class="text-muted mb-2 font-13"><strong>Status Pasien :</strong>
                                @if ($dtdiagnosa->status_pasien === 'Umum')
                                    <span class="badge bg-success">{{ $dtdiagnosa->status_pasien }}</span>
                                @else
                                    <span class="badge bg-danger">{{ $dtdiagnosa->status_pasien }}</span>
                                @endif
                            </p>

                            <p class="text-muted mb-2 font-13"><strong>Tempat, tanggal lahir :</strong><span class="ms-2">
                                    {{ $dtpasien->pasien_tempat_lahir }},
                                    {{ $dtpasien->pasien_tgl_lahir }}</span></p>
                                    ...
                                    <div class="inbox-item">
                                        ...
                                        <p class="inbox-item-date">
                                            <a href="#" class="btn btn-sm btn-link text-info font-13"
                                                ...
                                                data-kode="{{ $item->kode_pendaftaran }}">
                                                Detail
                                            </a>
                                        </p>
                                    </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h4 class="modal-title text-white" id="primary-header-modalLabel">Detail Riwayat Pemeriksaan
                            </h4>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                                aria-hidden="true"></button>
                        </div>
                        <div class="modal-body">
                            <p>Kode Pendaftaran: <span id="kodePendaftaran"></span></p>
                            <p>Diagnosa : <span id="diagnosa"></span></p>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content mb-3">
                            ...
                            <div class="tab-pane" id="diagnosa">
                                <form action="{{ route('detail.pasien.diagnosa', $dtdiagnosa->kode_pendaftaran) }}"
                                    class="comment-area-box" method="POST">
                                    @csrf
                                    <div id="notification"></div>
                                    <input type="hidden" name="kode_pendaftaran"
                                        value="{{ $dtdiagnosa->kode_pendaftaran }}">
                                    <input type="hidden" name="kode" id="kode"
                                        value="{{ $dtpasien->pasien_kode }}" hidden>
...
@section('script')
    <script type="text/javascript">
        ...
        //         var modal = $(this); // Modal yang dibuka
        //         var kodePendaftaran = button.data('kode');
        //         var diagnosa = button.data('diagnosa');

        //         console.log('Kode Pendaftaran:', kodePendaftaran);
        //         console.log('Diagnosa:', diagnosa);

        //         modal.find('#kodePendaftaran').text(kodePendaftaran);
