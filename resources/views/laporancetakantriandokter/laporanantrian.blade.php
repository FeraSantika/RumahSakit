                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Laporan Kartu Antrian</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Laporan Kartu Antrian Pasien Rawat
                                        Jalan</a>
                                </li>
                            </ol>
                        </div>
                        <h4 class="page-title">Laporan Kartu Antrian Pasien Rawat Jalan</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
...
@section('script')
    <script>
        function tampilkanData() {
            ...
            const url =
                `/admin/laporan-kartuantriandokter/get_data?tanggalAwal=${tanggalAwal}&tanggalAkhir=${tanggalAkhir}
                &pilihPoli=${pilihPoli}`;
            fetch(url)
        ...
        function exportPDFWithDates() {
            ...
            var pdfURL = "{{ route('laporan-kartuantriandokter.export-pdf') }}" + "?tanggalAwal=" + tanggalAwal +
                "&tanggalAkhir=" +
                tanggalAkhir;
        ...
        function exportExcel() {
            ...
            var excelURL = "{{ route('laporan-kartuantriandokter.export-excel') }}" + "?tanggalAwal=" + tanggalAwal +
