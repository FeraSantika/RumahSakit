            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Laporan Pendaftaran Pasien Rawat Jalan</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
...
@section('script')
    <script>
        function tampilkanData() {
            ...
            const url =
                `/admin/laporan-pasienJalan/get_data?tanggalAwal=${tanggalAwal}&tanggalAkhir=${tanggalAkhir}
        ...
        function exportPDFWithDates() {
            ...
            var pdfURL = "{{ route('laporan-pasienJalan.export-pdf') }}" + "?tanggalAwal=" + tanggalAwal +
                "&tanggalAkhir=" +
                tanggalAkhir;
            ...
            if (statusPemeriksaan) {
                pdfURL += "&statusPemeriksaan=" + statusPemeriksaan + "&pilihPoli=" + pilihPoli;
            }
        ...
        function exportExcel() {
            ...
            var excelURL = "{{ route('laporan-pasienJalan.export-excel') }}" + "?tanggalAwal=" + tanggalAwal +
