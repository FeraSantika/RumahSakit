                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Laporan Hasil</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Laporan Pasien Rawat Inap</a>
                                </li>
                            </ol>
                        </div>
                        <h4 class="page-title">Laporan Hasil Pasien Rawat Inap</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2 align-items-end">
                                ...
                                <div class="col-md-2">
                                    <label for=""></label>
                                    <button type="button" class="btn btn-success" onclick="tampilkanData()">Filter</button>
                                </div>
                                <div class="col-sm-2">
                                    <a href="#" type="submit" class="btn btn-light mb-2 me-1"
                                        onclick="exportExcel()"><i class="uil-print"></i>
                                        Excel</a>
                                    <a href="#" class="btn btn-primary mb-2 me-1" onclick="exportPDFWithDates()"><i
                                            class="uil-print"></i> PDF</a>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                <div class="table-responsive">
                                    <table class="table table-centered table-nowrap mb-0" id="tabelrawatinap">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
...
@section('script')
    <script>
        function tampilkanData() {
            ...
            const hasilData = document.getElementById('tabelrawatinap');
            hasilData.innerHTML = '';

            const url =
                `/admin/laporan-hasilpasienInap/get_data?tanggalAwal=${tanggalAwal}&tanggalAkhir=${tanggalAkhir}&statusPasien=${statusPasien}&statusPemeriksaan=${statusPemeriksaan}`;

            fetch(url)
                .then(response => response.json())
                .then(dataTerfilter => {
                    console.log('Response dari server:', dataTerfilter);
                    if (dataTerfilter.length > 0) {
                        ...
                        tableHTML += '<tr>';
                        tableHTML += '<td colspan="7" class="text-start"><strong> Grandtotal:</strong></td>';
                        tableHTML +=
        ...
        function exportPDFWithDates() {
            ...
            var pdfURL = "{{ route('laporan-hasilpasienInap.export-pdf') }}" + "?tanggalAwal=" + tanggalAwal +
                "&tanggalAkhir=" +
                tanggalAkhir;
        ...
        function exportExcel() {
            ...
            var excelURL = "{{ route('laporan-hasilpasienInap.export-excel') }}" + "?tanggalAwal=" + tanggalAwal +
