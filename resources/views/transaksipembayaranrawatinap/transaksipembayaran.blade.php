                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Transaksi Pembayaran</a></li>
                                <li class="breadcrumb-item active">Transaksi Pembayaran Rawat Inap</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Transaksi Pembayaran Pasien Rawat Inap</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                        ...
                                        @foreach ($dtpendaftar as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <a href="{{ route('transaksi-pembayaran-rawatinap.detail', $item->kode_pendaftaran) }}"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function performSearch(searchTerm) {
                $.ajax({
                    url: "{{ route('search.transaksi-pembayaran-rawatinap') }}",
                    type: 'GET',
                    dataType: "json",
                    data: {
                        cari: searchTerm
                ...
                if (data.length > 0) {
                    data.forEach(function(item) {
                        ...
                        resultList += "<tr>" +
                            ...
                            "<td><button class='btn " + badgesdibayar + " btn-sm'>" + statusobat +
                            '</button></td>' +
                            "<td><a href='/admin/transaksi-pembayaran-rawatinap/detail/update/print/" + item
                            .kode_pendaftaran +
        ...
        function printResi(kode) {
            ...
            fetch('/admin/transaksi-pembayaran-rawatinap/detail/update/print/' + kode, {
                    method: 'POST',
                    body: formData
                })
