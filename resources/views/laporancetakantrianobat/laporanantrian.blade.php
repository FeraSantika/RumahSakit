                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Laporan Kartu Antrian Apoteker</a>
                                </li>
                            </ol>
                        </div>
                        <h4 class="page-title">Laporan Kartu Antrian Apoteker</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
...
@section('script')
    <script>
        function tampilkanData() {
            ...
            const url = `/admin/laporan-kartuantrianobat/get_data?tanggalAwal=${tanggalAwal}&tanggalAkhir=${tanggalAkhir}`;
            fetch(url)
        ...
        function exportPDFWithDates() {
            ...
            var pdfURL = "{{ route('laporan-kartuantrianobat.export-pdf') }}" + "?tanggalAwal=" + tanggalAwal +
                "&tanggalAkhir=" +
                tanggalAkhir;
        ...
        function exportExcel() {
            ...
            var excelURL = "{{ route('laporan-kartuantrianobat.export-excel') }}" + "?tanggalAwal=" + tanggalAwal +
