            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Laporan Pendaftaran Pasien Rawat Inap</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
...
@section('script')
    <script>
        function tampilkanData() {
            ...
            const url =
                `/admin/laporan-pasienInap/get_data?tanggalAwal=${tanggalAwal}&tanggalAkhir=${tanggalAkhir}&statusPasien=${statusPasien}&statusPemeriksaan=${statusPemeriksaan}`;
        ...
        function exportPDFWithDates() {
            ...
            var pdfURL = "{{ route('laporan-pasienInap.export-pdf') }}" + "?tanggalAwal=" + tanggalAwal +
        ...
        function exportExcel() {
            ...
            var excelURL = "{{ route('laporan-pasienInap.export-excel') }}" + "?tanggalAwal=" + tanggalAwal +
                "&tanggalAkhir=" + tanggalAkhir;
