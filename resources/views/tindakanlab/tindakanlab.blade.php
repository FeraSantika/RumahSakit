            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Tindakan Lab</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-sm-5">
                                    <a href="{{ route('tindakan-lab.create') }}" class="btn btn-danger mb-2"><i
                                        ...
                                        @foreach ($dttindakan as $item)
                                            <tr>
                                                ...
                                                <td class="table-action">
                                                    <a href="{{ route('tindakan-lab.edit', $item->id_tindakan) }}"
                                                        class="action-icon">
                                                    ...
                                                    <form id="delete-form-{{ $item->id_tindakan }}"
                                                        action="{{ route('tindakan-lab.destroy', $item->id_tindakan) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                ...
                if (data.length > 0) {
                    data.forEach(function(item) {
                        resultList += "<tr>" +
                            ...
                            "<td>";
                        if (item.lab) {
                            item.lab.forEach(function(lab) {
                                resultList += lab.nama_lab + "<br>";
                            });
                        } else {
                            resultList += "Tidak ada data laboratorium<br>";
                        }
                        resultList += "</td>" +
